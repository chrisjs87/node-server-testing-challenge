...
- [COMPLETE] Clone your OWN version of the repository (Not Lambda's by mistake!).
- [COMPLETE] Create a new branch: git checkout -b `<firstName-lastName>`.
- [COMPLETE] Implement the project on your newly created `<firstName-lastName>` branch, committing changes regularly.
- [COMPLETE] Push commits: git push -u origin `<firstName-lastName>`.
